...
image2 = Image.open('data/123.jpeg')
...
if (st.button('Find Diabetes Risk Status')):
...
st.write('This is an prototype application and cannot be used as a substitute for real medical advice.')